              ...
              {hasSavedDnsConfig && !isFetchingDns && (
                <div className="flex items-center gap-1">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Esquecer credenciais DNS?</AlertDialogTitle>
                        <AlertDialogDescription>
                          As credenciais salvas (URL, usuário e senha) serão removidas permanentemente. Você precisará digitá-las novamente na próxima vez.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                        <AlertDialogAction onClick={handleClearDnsConfig} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
