      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Status da Segurança da Conta
          </CardTitle>
          <CardDescription>
            Estado atual da sua segurança no sistema
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <Badge variant="default" className="ml-2">✅ Logado</Badge>
            </div>
            <div>
              <Label>Sistema:</Label>
              <Badge variant="default" className="ml-2">🔐 Firebase Auth</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
