 ...
 *
 * Importante: não usamos mais Supabase Edge Function como fallback automático,
 * porque isso causava CORS e escondia o erro real retornado pelo Vercel/Baserow.
 */
...
async function makeProxyRequestOnce(payload: ProxyPayload): Promise<ProxyResponse> {
  console.log(`🌐 [ProxyRequest] Fazendo requisição via Vercel Proxy`, {
